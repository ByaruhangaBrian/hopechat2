...
```bash
# 1. Fork on GitHub: https://github.com/<your-username>/hopechat.git → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/<your-username>/hopechat.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/your-org/hopechat/issues/new?template=bug_report.yml)
...
- Rebrand. The HopeChat name, favicon, and any external documentation
  URLs belong to your fork; please swap them for your own before putting
