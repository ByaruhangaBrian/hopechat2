...
- [GitHub Security Advisories](https://github.com/your-org/hopechat/security/advisories/new)
...
In scope:
- Anything in this repository (`your-org/hopechat`), including webhook and auth
