          ...
          <div className="flex flex-col h-full">
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-muted/50 border-b border-border mx-4 mt-3">
                <TabsTrigger
                  value="details"
                  className="data-[state=active]:bg-background data-[state=active]:text-primary text-muted-foreground"
                >
                  Details
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="notes" className="flex-1 flex flex-col min-h-0 px-4 py-3">
                <div className="space-y-2 mb-3">
                  <Textarea
                    ...
                    className="bg-muted border-border text-foreground placeholder:text-muted-foreground/50 min-h-[60px] text-sm resize-none"
                  />
                  <Button
                    onClick={addNote}
                      ...
                      >
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button
                            ...
                            className="opacity-0 group-hover:opacity-100 text-muted-foreground/60 hover:text-destructive transition-all cursor-pointer shrink-0"
                          >
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="bg-muted border-border text-foreground h-8 text-sm placeholder:text-muted-foreground/50"
                        />
                      </div>
                    ))}
                    <Button
              ...
              <TabsContent value="deals" className="flex-1 overflow-y-auto px-4 py-3">
                {loadingDeals ? (
                  ...
                  <p className="text-xs text-muted-foreground/60">No deals yet</p>
                ) : (
