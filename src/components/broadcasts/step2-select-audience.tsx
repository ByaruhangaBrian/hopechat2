  ...
  return (
    <div className="space-y-6">
          ...
          {loadingFields ? (
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_140px_minmax(0,1fr)]">
              ...
              <input
                ...
                placeholder="Value"
                className="h-9 rounded-lg border border-border bg-muted px-2.5 text-sm text-foreground outline-none placeholder:text-muted-foreground/50 focus:border-primary focus:ring-1 focus:ring-primary"
              />
            </div>
          )}
        </div>
      ...
      <div className="rounded-xl border border-border bg-card/50 p-4">
        ...
        {tags.length === 0 ? (
          <p className="text-xs text-muted-foreground/60">No tags available.</p>
        ) : (
          <div className="flex flex-wrap gap-2">
            {tags.map((tag) => {
