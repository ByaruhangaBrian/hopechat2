                  ...
                  <button
                    ...
                    className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium transition-all ${
                      isSelected
                        ...
                        : 'border-slate-700 bg-muted text-slate-300 hover:border-slate-600'
                    }`}
                  >
                    <span
          ...
          {loadingFields ? (
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_140px_minmax(0,1fr)]">
              <select
                ...
                className="h-9 rounded-lg border border-slate-700 bg-muted px-2.5 text-sm text-white outline-none focus:border-primary focus:ring-1 focus:ring-primary"
              >
              ...
              <input
                ...
                placeholder="Value"
                className="h-9 rounded-lg border border-slate-700 bg-muted px-2.5 text-sm text-white outline-none placeholder:text-slate-500 focus:border-primary focus:ring-1 focus:ring-primary"
              />
            </div>
          )}
        </div>
