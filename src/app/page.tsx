  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground selection:bg-primary/30 antialiased font-sans">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-md transition-all duration-300">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/signup">
              <Button className="bg-primary hover:bg-primary/95 text-primary-foreground font-bold px-5 h-9 text-xs sm:text-sm shadow-md shadow-primary/10 transition-transform hover:scale-[1.02] active:scale-[0.98] duration-200 rounded-lg">
                Start Free Trial
              </Button>
            </Link>
            <button 
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12">
            ...
            <div className="relative mx-auto max-w-5xl rounded-2xl border border-border/50 bg-card/80 backdrop-blur-md shadow-2xl overflow-hidden aspect-[16/10] md:aspect-[16/9] flex text-left font-sans text-[11px] sm:text-xs md:text-sm animate-in fade-in zoom-in-95 duration-1000 delay-400">
              ...
              <div className="flex-1 flex flex-col">
                ...
                {/* Animated Message History Feed (Scoped overflow area to fix auto-scroll window bug) */}
                <div 
                  ref={chatContainerRef} 
                  className="flex-1 p-4 overflow-y-auto space-y-3 bg-muted/10 transition-all duration-300"
                >
                    ...
                    return (
                      <div 
                        ...
                        className={cn("flex gap-2.5 items-end max-w-[85%] animate-in slide-in-from-bottom-2 duration-300", 
                          isBot ? "ml-auto flex-row-reverse animate-in slide-in-from-bottom-2" : "mr-auto")}
                      >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
              {[
                ...
                <FadeIn key={index} delay={index * 100}>
                  <div className="group p-6 rounded-2xl bg-card border border-border/40 shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300 hover:-translate-y-0.5 flex flex-col justify-between h-full">
            ...
            <div className="grid sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                ...
                <FadeIn key={index} delay={index * 150}>
                  <div className="p-8 rounded-2xl bg-card border border-border/40 shadow-sm flex flex-col justify-between text-left space-y-4 hover:border-primary/20 transition-colors h-full">
            ...
            <div className="grid sm:grid-cols-3 gap-6 max-w-5xl mx-auto text-left">
              {[
                ...
                <FadeIn key={i} delay={i * 100}>
                  <div className="p-6 rounded-2xl bg-card border border-border/40 space-y-4 hover:border-primary/20 transition-all duration-300 h-full">
        ...
        {/* Completely Light-Themed Call to Action Banner (SaleSmartly-inspired) */}
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            <FadeIn>
              <div className="rounded-3xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 p-8 md:p-16 lg:p-20 text-center text-foreground overflow-hidden relative shadow-lg">
                {/* Blur backdrop bubbles */}
                <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-80 h-80 bg-primary/5 rounded-full blur-3xl pointer-events-none" />
                <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 w-80 h-80 bg-primary/10 rounded-full blur-3xl pointer-events-none" />
                
                <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
                  <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-none text-foreground">Ready to Own Your Chat Infrastructure?</h2>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                    <Link href="/signup" className="w-full sm:w-auto">
                      <Button size="lg" className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground h-12 px-8 text-base font-bold rounded-xl active:scale-[0.98] transition-transform shadow-md">
                        Get Started Free
                      </Button>
                    </Link>
                    <Link href="/login" className="text-sm font-bold text-muted-foreground hover:text-foreground transition-colors py-2 px-4">
